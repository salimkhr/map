...
public class TraitementListeVille {
	
	private String reponse;
	
	public TraitementListeVille(String xml)
	{
		try
		{
			...
			for(int  j = 0;j<nbClients;j++)
			{
				...
				reponse+="<Client><Id>"+(j+1)+"</Id><Order>1</Order></Client>";
				reponse+="</Trip>";
			}
	...
	{
		TraitementListeVille t = new TraitementListeVille("<VRPXMLQuery><ProblemData><Vehicles><Vehicle><Capacity>1000</Capacity><Speed>90</Speed><FixCost>300</FixCost><VarCost>50</VarCost>"
